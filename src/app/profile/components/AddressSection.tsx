        ...
        return (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Alternative Address (Optional)</label>
                        <input
                            type="text"
    ...
    return (
        <div className="space-y-6">
            <button
                ...
                className="w-full p-8 border-2 border-dashed border-gray-300 text-gray-900 rounded-lg flex items-center justify-center text-gray-600 hover:text-green-600 hover:border-green-600"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {addresses.map((address, index) => (
                    <div key={index} className="p-4 border rounded-lg relative">
                        ...
                        <h3 className="font-semibold mb-2 text-gray-900">{address.type} Address</h3>
